...
function applyGrid(req,res,render_page){
	async.auto({
		...
		res.render(render_page,{title:"Home",message:'',permission:permission,collection:collection,subcol:subcol,subgridPermission:subgridPermission});
	});
}
module.exports = {
		home : function(req,res){
			req.params.table = 'alert';
			req.params.process = 'record'
			applyGrid(req,res,'page');
